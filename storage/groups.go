...
// CreateGroup Create добавляет нового пользователя в базу данных
func (db *DB) CreateGroup(group structures.Group) (int, error) {
	var id int
...
func (db *DB) ReadGroupinfo(id int) (structures.Group, error) {
...
// UpdateGroupinfo Update обновляет информацию о пользователе
func (db *DB) UpdateGroupinfo(group structures.Group) error {
...
// DeleteGroup Delete удаляет пользователя по ID
